...
public class ReLogoTurtle extends BaseTurtle{
	...
	/**
	 * Makes a number of new gardeners and then executes a set of commands on the
	 * created gardeners.
	 * 
	 * @param number
	 *            a number
	...
	public AgentSet<garden.relogo.Gardener> hatchGardeners(int number, Closure closure) {
		AgentSet<garden.relogo.Gardener> result = new AgentSet<>();
		AgentSet<Turtle> createResult = this.hatch(number,closure,"Gardener");
	 ...
	 */
	@ReLogoBuilderGeneratedFor("garden.relogo.Gardener")
	public AgentSet<garden.relogo.Gardener> hatchGardeners(int number) {
		return hatchGardeners(number,null);
	}
	...
	/**
	 * Makes a number of new plants and then executes a set of commands on the
	 * created plants.
	 * 
	 * @param number
	 *            a number
	...
	public AgentSet<garden.relogo.Plant> hatchPlants(int number, Closure closure) {
		AgentSet<garden.relogo.Plant> result = new AgentSet<>();
		AgentSet<Turtle> createResult = this.hatch(number,closure,"Plant");
		for (Turtle t : createResult){
	 ...
	 */
	@ReLogoBuilderGeneratedFor("garden.relogo.Plant")
	public AgentSet<garden.relogo.Plant> hatchPlants(int number) {
		return hatchPlants(number,null);
	}
	...
	/**
	 * Makes a number of new rabbits and then executes a set of commands on the
	 * created rabbits.
	 * 
	 * @param number
	 *            a number
	...
	public AgentSet<garden.relogo.Rabbit> hatchRabbits(int number, Closure closure) {
		AgentSet<garden.relogo.Rabbit> result = new AgentSet<>();
		AgentSet<Turtle> createResult = this.hatch(number,closure,"Rabbit");
		for (Turtle t : createResult){
	 ...
	 */
	@ReLogoBuilderGeneratedFor("garden.relogo.Rabbit")
	public AgentSet<garden.relogo.Rabbit> hatchRabbits(int number) {
		return hatchRabbits(number,null);
	}
	...
	public AgentSet<garden.relogo.UserTurtle> hatchUserTurtles(int number, Closure closure) {
	 ...
	 */
	@ReLogoBuilderGeneratedFor("garden.relogo.UserTurtle")
	public AgentSet<garden.relogo.UserTurtle> hatchUserTurtles(int number) {
	...
	public garden.relogo.UserLink createUserLinkFrom(Turtle t, Closure closure){
		garden.relogo.UserLink link = (garden.relogo.UserLink)this.getMyObserver().getNetwork("UserLink").addEdge(t,this);
		if (closure != null){
	 ...
	 */
	@ReLogoBuilderGeneratedFor("garden.relogo.UserLink")
	public garden.relogo.UserLink createUserLinkFrom(Turtle t){
	 ...
	 */
	@ReLogoBuilderGeneratedFor("garden.relogo.UserLink")
	public AgentSet<garden.relogo.UserLink> createUserLinksFrom(Collection<? extends Turtle> a, Closure closure){
		AgentSet<garden.relogo.UserLink> links = new AgentSet<garden.relogo.UserLink>();
		for(Turtle t : a){
			links.add((garden.relogo.UserLink)this.getMyObserver().getNetwork("UserLink").addEdge(t,this));
		}
		if (closure != null){
	 ...
	 */
	@ReLogoBuilderGeneratedFor("garden.relogo.UserLink")
	public AgentSet<garden.relogo.UserLink> createUserLinksFrom(Collection<? extends Turtle> a){
	 ...
	 */
	@ReLogoBuilderGeneratedFor("garden.relogo.UserLink")
	public garden.relogo.UserLink createUserLinkTo(Turtle t, Closure closure){
		garden.relogo.UserLink link = (garden.relogo.UserLink)this.getMyObserver().getNetwork("UserLink").addEdge(this,t);
		if (closure != null){
			this.ask(link,closure);
		}
		return link;
	 ...
	 */
	@ReLogoBuilderGeneratedFor("garden.relogo.UserLink")
	public garden.relogo.UserLink createUserLinkTo(Turtle t){
	 ...
	 */
	@ReLogoBuilderGeneratedFor("garden.relogo.UserLink")
	public AgentSet<garden.relogo.UserLink> createUserLinksTo(Collection<? extends Turtle> a, Closure closure){
		AgentSet<garden.relogo.UserLink> links = new AgentSet<garden.relogo.UserLink>();
		for(Object t : a){
			if (t instanceof Turtle){
				links.add((garden.relogo.UserLink)this.getMyObserver().getNetwork("UserLink").addEdge(this,(Turtle)t));
			}
		}
		if (closure != null){
			this.ask(links,closure);
	 ...
	 */
	@ReLogoBuilderGeneratedFor("garden.relogo.UserLink")
	public AgentSet<garden.relogo.UserLink> createUserLinksTo(Collection<? extends Turtle> a){
	 ...
	 */
	@ReLogoBuilderGeneratedFor("garden.relogo.UserLink")
	public garden.relogo.UserLink inUserLinkFrom(Turtle t){
		return (garden.relogo.UserLink)this.getMyObserver().getNetwork("UserLink").getEdge(t,this);
	}
	 ...
	 */
	@ReLogoBuilderGeneratedFor("garden.relogo.UserLink")
	public AgentSet<garden.relogo.UserLink> myInUserLinks(){
		AgentSet<garden.relogo.UserLink> result = new AgentSet<garden.relogo.UserLink>();
		for(Object o :  this.getMyObserver().getNetwork("UserLink").getInEdges(this)){
			if (o instanceof garden.relogo.UserLink){
				result.add((garden.relogo.UserLink) o);
			}
		}
		return result;
	}
	 ...
	 */
	@ReLogoBuilderGeneratedFor("garden.relogo.UserLink")
	public AgentSet<garden.relogo.UserLink> myOutUserLinks(){
		AgentSet<garden.relogo.UserLink> result = new AgentSet<garden.relogo.UserLink>();
	 ...
	 */
	@ReLogoBuilderGeneratedFor("garden.relogo.UserLink")
	public garden.relogo.UserLink outUserLinkTo(Turtle t){
		return (garden.relogo.UserLink)this.getMyObserver().getNetwork("UserLink").getEdge(this, t);
	}
	 ...
	 */
	@ReLogoBuilderGeneratedFor("garden.relogo.UserLink")
	public AgentSet<garden.relogo.UserLink> myUserLinks(){
		AgentSet<garden.relogo.UserLink> result = new AgentSet<garden.relogo.UserLink>();
